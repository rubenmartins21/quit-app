...
function useLiveElapsed(startedAt?: string): Elapsed | null {
  const [e, setE] = useState<Elapsed | null>(
...
export function DashboardScreen({ user, onNavigate }: Props) {
  ...
  function renderStreak() {
    ...
    return (
      <>
        <div style={{ ...S.bigNum, opacity: hasPendingQuit ? 0.4 : 1 }}>
          {elapsed.days}
        </div>
        ...
        {challenge === undefined ? (
          ...
          <>
            ...
            <Card>
              ...
              >
                ...
                <span style={S.badge}>
                  {t.dash.daysLeft(challenge.progress.daysRemaining)}
                </span>
              </div>
              <div
                style={{
            ...
            {!hasPendingQuit && (
              <div>
                <button
                  style={S.btnQuit}
                  onClick={() => setShowQuitFlow(true)}
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.borderColor =
                      "#C44536";
                    (e.currentTarget as HTMLElement).style.color = "#C44536";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.borderColor =
                      "#C8D8CE";
            ...
            {blockerActive && blockerStatus && (
              <div>
                <AddBlockedUrlCard
                  ...
                  onUpdated={() => ipc.blocker.status().then(setBlockerStatus)}
                />
              </div>
            )}
          </>
          ...
          <Card dashed>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.background = "#173222";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.background = "#1F3D2B";
              }}
            >
              {t.create.btn}
            </button>
        ...
        {!blockerActive && challenge && (
          <Card>
            ...
            >
              ...
              <span
                style={{ ...S.badge, background: "#FFF3E0", color: "#E65100" }}
              >
                OFF
              </span>
            </div>
...
const S: Record<string, React.CSSProperties> = {
  ...
  dot: {
    ...
    borderRadius: "50%",
    background: "#1F3D2B",
    boxShadow: "0 0 0 3px rgba(31,61,43,.15)",
    flexShrink: 0,
